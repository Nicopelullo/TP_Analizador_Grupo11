...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PARENTESISIZQUIERDO = 7,        /* PARENTESISIZQUIERDO  */
  YYSYMBOL_PARENTESISDERECHO = 8,          /* PARENTESISDERECHO  */
  YYSYMBOL_PUNTOYCOMA = 9,                 /* PUNTOYCOMA  */
  YYSYMBOL_SUMA = 10,                      /* SUMA  */
  YYSYMBOL_RESTA = 11,                     /* RESTA  */
  YYSYMBOL_COMA = 12,                      /* COMA  */
  YYSYMBOL_ASIGNACION = 13,                /* ASIGNACION  */
  YYSYMBOL_CONSTANTE = 14,                 /* CONSTANTE  */
  YYSYMBOL_IDENTIFICADOR = 15,             /* IDENTIFICADOR  */
  YYSYMBOL_YYACCEPT = 16,                  /* $accept  */
  YYSYMBOL_programa = 17,                  /* programa  */
  YYSYMBOL_listaDeSentencias = 18,         /* listaDeSentencias  */
  YYSYMBOL_sentencia = 19,                 /* sentencia  */
  YYSYMBOL_listaDeIdentificadores = 20,    /* listaDeIdentificadores  */
  YYSYMBOL_listaDeExpresiones = 21,        /* listaDeExpresiones  */
...
static const char *const yytname[] =
{
  ...
  "LEER", "ESCRIBIR", "PARENTESISIZQUIERDO", "PARENTESISDERECHO",
  "PUNTOYCOMA", "SUMA", "RESTA", "COMA", "ASIGNACION", "CONSTANTE",
  "IDENTIFICADOR", "$accept", "programa", "listaDeSentencias", "sentencia",
  "listaDeIdentificadores", "listaDeExpresiones", "expresion", "primaria", YY_NULLPTR
};
...
{
       1,     2,    28,    22,    23,    18,    -3,   -20,   -20,    17,
      -1,    -1,   -20,   -20,   -20,     3,    -1,   -20,   -20,    10,
       9,   -20,    16,    24,    19,    13,    26,    -1,    -1,    -1,
     -20,   -20,   -20,   -20,   -20,     9,   -20,   -20
};
...
{
      22,    12,     3,     4,     1,    25,    16,     3,     4,    36,
      37,    23,     5,    17,    18,    24,    35,     5,    26,    28,
      29,    33,    27,    28,    29,    30,    28,    29,     8,     9,
      10,    11,    14,    31,    32,    34,    13
};

static const yytype_int8 yycheck[] =
{
      11,     4,     5,     6,     3,    16,     7,     5,     6,    28,
      29,     8,    15,    14,    15,    12,    27,    15,     8,    10,
      11,     8,    12,    10,    11,     9,    10,    11,     0,     7,
       7,    13,    15,     9,    15,     9,     6
};
...
{
       0,     3,    17,     5,     6,    15,    18,    19,     0,     7,
       7,    13,     4,    19,    15,    20,     7,    14,    15,    21,
      22,    23,    22,     8,    12,    22,     8,    12,    10,    11,
       9,     9,    15,     8,     9,    22,    23,    23
};
